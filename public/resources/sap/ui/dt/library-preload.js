...
a.prototype.run=function(){var b=this;return this._setup().then(function(){b._mResult=b.createSuite("Element Enablement Test");var e=b.addGroup(b._mResult.children,b.getType(),"Given that an DesignTime is created for "+b.getType());b._testAggregations(e.children);b._mResult=b.aggregate(b._mResult);return b._mResult;});};
